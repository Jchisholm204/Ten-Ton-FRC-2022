...
void TalonConfiguation::winchMotor(TalonFX &iMotor){
    ...
    motorConfig.primaryPID.selectedFeedbackSensor = FeedbackDevice::IntegratedSensor;
    // Configure the Motor's Integrated PID
    motorConfig.slot0.kP = 3.0; // Standard PID kP - used for MagicMotion Movement
    motorConfig.slot0.kI = 0.0; // Standard PID kP - used for MagicMotion Movement
    motorConfig.slot0.kD = 18.0; // Standard PID kP - used for MagicMotion Movement
    motorConfig.slot0.kF = 0.1; // kF - Feed Forward Value - The Minimum Motor Power Required to Move the Motor
    ...
    motorConfig.motionCurveStrength = 1;
